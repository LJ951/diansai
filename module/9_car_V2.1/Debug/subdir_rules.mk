...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs2011/ccs/tools/compiler/ti-cgt-armllvm_4.0.3.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O0 -I"C:/Users/22334/workspace_ccstheia/9_car_V2.1/BSP/MPU6050" -I"C:/Users/22334/workspace_ccstheia/9_car_V2.1/BSP/MPU6050/DMP" -I"C:/Users/22334/workspace_ccstheia/9_car_V2.1/Control" -I"C:/Users/22334/workspace_ccstheia/9_car_V2.1/HARDWARE" -I"C:/Users/22334/workspace_ccstheia/9_car_V2.1/modules/src" -I"C:/Users/22334/workspace_ccstheia/9_car_V2.1/modules/inc" -I"C:/Users/22334/workspace_ccstheia/9_car_V2.1" -I"C:/Users/22334/workspace_ccstheia/9_car_V2.1/Debug" -I"C:/ti/mspm0_sdk_2_04_00_06/source/third_party/CMSIS/Core/Include" -I"C:/ti/mspm0_sdk_2_04_00_06/source" -gdwarf-3 -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-47529711: ../empty.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/sysconfig_1.21.1/sysconfig_cli.bat" --script "C:/Users/22334/workspace_ccstheia/9_car_V2.1/empty.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_04_00_06/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-47529711 ../empty.syscfg
device.opt: build-47529711
device.cmd.genlibs: build-47529711
ti_msp_dl_config.c: build-47529711
ti_msp_dl_config.h: build-47529711
Event.dot: build-47529711
